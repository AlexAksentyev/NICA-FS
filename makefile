...
COMMON = $(addsuffix .bin, NICA/header BENDS3/header FIRST-ST/header)
SETUPS = $(addsuffix .bin, NICA/FULL NICA/SEQFULL BENDS3/FULL BENDS3/SEQFULL FIRST-ST/FULL FIRST-ST/SEQFULL FIRST-ST/BARE)
